...
public class Main {
    ...
    /*
    * Effect: Prompts user for Subscriber ID, removes if found.
    */
    public static void removeSubscriber() {
        System.out.print("Enter Subscriber ID to remove: ");
        String id = scanner.nextLine();
        boolean removed = ourSystem.removeSubscription(id);

        if (removed) {
            System.out.println("Subscriber removed successfully.");
        } else {
            System.out.println("Subscriber not found or failed to remove.");
        }
    }
    ...
    /*
    * Effect: Prompts user for Manager ID, removes if found.
    */
    public static void removeManager() {
        System.out.print("Enter Manager ID to remove: ");
        String id = scanner.nextLine();
        boolean removed = ourSystem.removeManager(id);

        if (removed) {
            System.out.println("Manager removed successfully.");
        } else {
            System.out.println("Manager not found or failed to remove.");
        }
    }
    ...
    /*
    * Effect: Prompts user for Taxi Code, removes if found.
    */
    public static void removeTaxi() {
        ...
        if (removed) {
            ...
            System.out.println("Taxi not found or failed to remove.");
        }
    }
